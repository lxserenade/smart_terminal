function chart(){
    ...
    date = $('#datetimepicker1').data("DateTimePicker").date().format('GGGG-MM-DD');
    $.ajax({
            url: "/ajax/category_statistic/?terminal_name="+terminal_name+"&date="+date+"&sortby=click-",
            type: "get",
            dataType: "json",
            success: function (d) {
               console.log(d)
...
$('#datetimepicker1').data("DateTimePicker").defaultDate('2015-09-09')
